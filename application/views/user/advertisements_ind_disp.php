<section id="content">
    ...
    <div class="container">
        <div class="row">
            ...
            <?php $count = $images->num_rows();if($count !=0): $adcount = $advertisements->num_rows(); if($adcount >0):?>
				...
				foreach ($images->result() as $image):$j++;?>
					...
					if($this->session->id == $row->user_id):?>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col s6">By <a href="#"><?= $row->firstname.' '.$row->middlename.' '.$row->lastname ?></a>
                                            <br><span class="left"><?php if($row->ad_starttime>0):echo date('d M,y',$row->ad_starttime);endif;?></span></div>
                                    </div>
                                </div>
                            <?php endforeach;?>
                ...
                <?php else : ?>
                    ...
                    <?php endif; ?>
                        ...
                        <?php endif; ?>
                            ...
                            <?php ?>
                                ...
                                <?php if($count ==0):   $adcount = $advertisements->num_rows(); if($adcount >0): ?>
					...
					if($this->session->id == $row->user_id):?>
                                                        ...
                                                        <h4 class="flow-text grey-text text-darken-4"><a href="#" class="grey-text text-darken-4"><?php echo ucfirst($row->ad_name);?></a></h4>
