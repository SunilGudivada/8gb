      ...
      <form class="password-form" >
        <div class="row center">
          <div class="input-field col s12">
            ...
            <p class="center login-form-text "><b>Password Change</b></p>
          </div>
        </div>
        <div class="row margin id">
          <div class="input-field col s12 center">
            <input id="username" type="text" class="center white-text" name="userid" required placeholder="admin" disabled value="admin">
          </div>
        </div>
...
<script>
  $(document).ready(function(){
    ...
    $('.btn-submit').click(function(){
      ...
      console.log(data);
      $.post('<?= base_url('index.php/auth/updateAdminPass/') ?>',data,function(msg){
